...
#              The positive x direction is towards the left
#
#        -- In what direction on the screen
#           does the positive Y-axis point?
#              The positive y direction is pointing downwards from the window
#
...
#            It will draw all the items on the window
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            So that the window doesn't automatically closes itself after the code finishes running
#
